...
document.addEventListener('DOMContentLoaded', () => {
  ...
  aboutSection.textContent = `Website ini dibuat oleh dua kelompok yang berkolaborasi. Kelompok pertama terdiri dari ${teamPembuatWeb.length} anggota yang bertugas membuat website, sedangkan kelompok kedua terdiri dari ${teamReviewerWeb.length} anggota untuk review hasil dari pembuatan website ini dan memastikan tidak ada bug, serta website ini adalah sebagai salah satu syarat tugas akhir dari mata kuliah Interaksi Manusia Dan Komputer.`;
